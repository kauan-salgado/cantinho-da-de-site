...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Hospedagem em Brasília | Cantinho da Dê',
    description: 'Casa inteira para até 6 hóspedes, com piscina, sinuca e salão, a 15 minutos do Plano Piloto.',
    url: '/hospedagem',
...
export default function HospedagemPage() {
  return (
    <main className="site-shell">
      ...
      <section className="hero" id="inicio">
        ...
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            <a className="button button-gold" href="/reservar?tipo=hospedagem">Consultar disponibilidade <span>→</span></a>
            <a className="button button-ghost" href={airbnbUrl} target="_blank" rel="noreferrer">Ver no Airbnb <span>↗</span></a>
          </div>
        </div>
        ...
        <div className="doors">
          <a className="door" href="/">
            ...
            <div>
              ...
              <p>Salão para 30 pessoas sentadas, com dois banheiros exclusivos, jardim e pomar.</p>
      ...
      <section className="closing-cta"><div><p className="eyebrow">Seu próximo encontro começa aqui</p><h2>Venha viver o{' '}<br />Cantinho da Dê.</h2></div><a className="button button-gold" href="/reservar?tipo=hospedagem">Ver datas disponíveis <span>→</span></a></section>
