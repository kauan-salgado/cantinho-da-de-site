    ...
    <main className="site-shell">
      ...
      <section className="feature section">
        <div className="feature-image">
          <img src="/site/piscina.jpg" alt="Piscina do Cantinho da Dê ao anoitecer" width={1600} height={900} loading="lazy" />
          <span>01</span>
        </div>
        <div className="feature-copy">
          ...
          <ul>
            <li>Piscina aquecida por energia solar</li>
            <li>Fogueira ao ar livre</li>
            <li>Pomar, jardim e mesa de sinuca</li>
